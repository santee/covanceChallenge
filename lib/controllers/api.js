...
var IRIS_DEFAULT = 'iris_default';
var IRIS_3000 = 'iris_randomized_3000_points';
var IRIS_15000 = 'iris_randomized_15000_points';
...
var getDataSetName = function(query) {
  ...
  if (!_.contains(dataSetNames, reqName)) {
    ...
    //console.log('Cannot find specified dataset: ' + reqName, '. Using default.');
    //return dataSetNames[0];
  }
